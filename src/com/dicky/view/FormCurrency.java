...
package com.dicky.view;

import com.dicky.dao.BarangDao;
 ...
 * @author dicky-java
 */
public class FormCurrency extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCurrency.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCurrency().setVisible(true);
            }
        });
    }
